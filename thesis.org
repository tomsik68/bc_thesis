...
** Properties of a reaching definitions analysis
Reaching definitions analyses have some properties that affect how
their accuracy. Less accurate analyses need to make some conservative
...
Among the definition, use and variable, an instance-wise reaching
