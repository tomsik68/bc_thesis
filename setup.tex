...
\thesissetup{
  ...
  The new analysis is based on transformation of memory operations in
  a program to static single assignment form, which directly reveals
  reaching definitions. Experimental measurements reveal that the new
  implementation turns out to be slower than the original one.
  We also investigate why that is and propose necessary changes to the
  implementation.
  },
